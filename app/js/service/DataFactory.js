...
(function () { 
    //debugger;
    angular.module('FD360').factory('DataFactory', ['$http', DataFactory]);
    ...
    function DataFactory($http)
    {
        ...
        Factory.addEmployees = function (Employee) {
        ...
        Factory.editCourse = function (Course) {
          //  debugger          
            for (var x = 0; x < Courses.length; x++) {
                if (Courses[x].CourseID = Course.CourseID)
                {
                    Courses[x].Name = Course.Name;
                    Courses[x].Code = Course.Code;
                    Courses[x].Description = Course.Description;
                    break;
                }
            }
        }
        ...
        Factory.deleteCourse = function (Course) {
            // debugger  
            Courses = $.grep(Courses, function (e) {
                return e.CourseID != Course.CourseID;
            });
        }
